...
// pub struct MprisPlayerBlock;

// impl Block for MprisPlayerBlock {
//     fn show(&self) -> String {
//         let conn = Connection::new_session().unwrap();
//         let players: Vec<MprisPlayer> = get_players(&conn)
//             .into_iter()
...
//         let metadata = player.metadata(&conn);
//         println!("{}", player.namespace);
//         println!("is playing: {}", player.is_playing(&conn));
